...
Thanks for checking out the Stacks Track! We think it’s one of the best opportunities at the MIT Bitcoin Expo hackathon to experiment with web3 on Bitcoin. The [Stacks blockchain](https://www.stacks.co/) is a really unique implementation of a smart contract-enabled decentralized network, and developers are praising the short learning curve for beginners and high functionality ceiling for experts.  

It uses the [**proof-of-transfer**](https://docs.stacks.co/understand-stacks/proof-of-transfer) consensus mechanism, which is a totally novel method of securing a blockchain by expanding the security of a more established network. In this case, PoX miners on Stacks commit BTC to compete for mined blocks, instead of expending electricity or computational power. Stacks also has a secondary value creation mechanism built-in, [Stacking](https://www.stacks.co/learn/stacking), where the BTC that miners committed is then divided and rewarded to “Stackers”. These Stackers have supported the network by locking up STX tokens for a number of cycles, and are rewarded with a proportion of the BTC used in mining. 

One final special aspect of Stacks is its smart contract programming language, [Clarity](https://clarity-lang.org/). Ethereum’s Solidity language proved the potential and desire for expressive web3 applications over the last few years, but it is buggy, hard to learn, and easy for beginners to overlook potential attack vectors. Stacks’ smart contract framework, Clarity, was designed explicitly to overcome some of the shortcomings and vulnerabilities that have been observed around the crypto industry. It’s turing-incompleteness prevents the chaotic and variable gas markets that have made Ethereum so inaccessible to retail consumers. It’s also based on LISP, a familiar language that allows newcomers to easily translate experience with parenthetical architectures to Clarity. 
...
[HackerNoon - WTF is Proof of Transfer (and Why Should Anyone Care)](https://hackernoon.com/wtf-is-proof-of-transfer-and-why-should-anyone-care-wd2330p9) 

[Get Started Building](https://www.stacks.co/build/get-started)

### 🔮 Clarity Basics

If Stacks is the futuristic crypto space station colony of the future, Clarity is the space ship that is gonna take us there. It’s the powerful toolbox that allows developers to build the decentralized alternatives to the hegemonic Web 2.0 apps that make users the product like Facebook, Amazon, or Google. There are loads of resources and tutorials out in the wild for hackers to quickly learn the fundamentals, and boilerplates galore to get you started. 
- [Clarity Overview](https://docs.stacks.co/write-smart-contracts/overview)
- [Clarity Development Environment (Setting up your IDE and dependencies)](https://docs.stacks.co/write-smart-contracts/software)
- [Clarity Book Knowledge Base](https://book.clarity-lang.org/)
- [Clarinet 101 - Youtube Playlist](https://youtube.com/playlist?list=PL5Ujm489LoJaAz9kUJm8lYUWdGJ2AnQTb)
- [Hiro Hacks Coding Demos - Youtube Playlist](https://youtube.com/playlist?list=PL5Ujm489LoJZGuiLot9LKvy_rjvHhAByn)
- [Deployed Clarity Smart Contract Archive](https://clarity-deployed-contracts.netlify.app/)

### 🏗️ Building Apps on Stacks

Once you’ve laid the groundwork, and your ready to start truly building, follow some of these guides to turn your rough idea into a fully-fledged decentralized app.
- [Developing a React frontend to a Clarity smart contract - Video Demo](https://youtu.be/e-IfT5CI-Gw)
...
- [Stacks On Chain](https://stacksonchain.com/)
...
Good luck! Here at Stacks, we always say that the internet isn’t going to decentralize itself. It takes passionate developers to build the world wide web of tomorrow. 
